...
const styles = StyleSheet.create({
  ...
  mapWrap: { borderBottomLeftRadius: 16, borderBottomRightRadius: 16, overflow: 'hidden', backgroundColor: dark.lowest },
  ...
  lanePill: { backgroundColor: dark.pinkContainer, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 12 },
  ...
  glassPill: { ...glass, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12 },
  speedWrap: { position: 'absolute', left: 12, bottom: 20 },
  speedPod: { ...glass, borderRadius: 16, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 12, boxShadow: '0px 1px 3px rgba(16,24,40,0.08)' },
  ...
  roundTool: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', boxShadow: '0px 1px 3px rgba(16,24,40,0.08)' },
  etaCard: { backgroundColor: dark.low, borderRadius: 16, padding: 16, gap: 12 },
  ...
  gainPill: { backgroundColor: dark.lowest, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 12 },
  actions: { flexDirection: 'row', gap: 8 },
  action: { flex: 1, height: 56, borderRadius: 16, backgroundColor: dark.container, alignItems: 'center', justifyContent: 'center', gap: 2 },
  parking: {
    flex: 1,
    height: 56,
    borderRadius: 12,
