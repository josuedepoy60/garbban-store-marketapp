...
const styles = StyleSheet.create({
  ...
  routeCard: { backgroundColor: 'rgba(255,255,255,0.92)', borderRadius: 32, padding: 16, gap: 16, overflow: 'hidden', boxShadow: '0px 12px 32px -6px rgba(75,54,201,0.09)' },
  blob: { position: 'absolute', right: -32, top: -32, width: 112, height: 112, borderRadius: 56, backgroundColor: 'rgba(228,223,255,0.5)' },
  ...
  dayActive: { minWidth: 76, backgroundColor: colors.primary, transform: [{ scale: 1.03 }], boxShadow: '0px 8px 20px -2px rgba(75,54,201,0.45)' },
  ...
  timeActive: { backgroundColor: colors.primaryContainer, borderWidth: 2, borderColor: colors.secondaryContainer, boxShadow: '0px 8px 20px rgba(75,54,201,0.35)' },
  driverCard: { backgroundColor: 'rgba(255,255,255,0.92)', borderRadius: 32, padding: 16, gap: 8, boxShadow: '0px 8px 24px -4px rgba(75,54,201,0.07)' },
  rating: {
    position: 'absolute',
    right: -4,
    bottom: -4,
  ...
  trust: { backgroundColor: 'rgba(247,241,255,0.7)', borderRadius: 16, padding: 8, gap: 4 },
  dock: {
  ...
  cta: {
    ...
    justifyContent: 'center',
    gap: 8,
    boxShadow: '0px 14px 30px -6px rgba(75,54,201,0.45)',
  },
});
